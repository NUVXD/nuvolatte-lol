const translations = {
    italian: {
        ...
        change2802: "<p>Aggiunto un contatore per le visite uniche, funziona sul local storage</p><p>Aggiunto un generatore di immagini randomico, lavora sull'API di Reddit</p>",
        // VIRTUALPIANO
        vpVolLow: "Basso",
        vpVolHigh: "Alto",
